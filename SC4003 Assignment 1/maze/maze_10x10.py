...
num_green = random.randint(10, int(max_cells * 0.25))    # max 25% of cells
num_brown = random.randint(10, int(max_cells * 0.25))    # max 25% of cells
num_wall  = random.randint(10, int(max_cells * 0.25))    # max 25% of cells
