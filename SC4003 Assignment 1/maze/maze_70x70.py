...
num_green = random.randint(100, int(max_cells * 0.25))                  # max 25% of cells
num_brown = random.randint(100, int(max_cells * 0.25))                  # max 25% of cells
num_wall  = random.randint(int(max_cells * 0.5), int(max_cells * 0.6))  # 50% to 60% of cells
